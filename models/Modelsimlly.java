...
public static class Modelsimlly extends ModelBase {
	...
	public Modelsimlly() {
		...
		upper_right_r1.cubeList
				.add(new ModelBox(upper_right_r1, 40, 32, -5.0591F, -1.4256F, -2.2467F, 4, 6, 4, 0.0F, false));
		...
		lower_left_r1.cubeList
				.add(new ModelBox(lower_left_r1, 40, 37, -2.03F, -0.2352F, -1.7914F, 4, 7, 4, 0.0F, true));
