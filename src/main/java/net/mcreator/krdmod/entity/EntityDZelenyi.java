...
public class EntityDZelenyi extends ElementsKrdModMod.ModElement {
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("krd_mod", "d_zelenyi"), ENTITYID)
				.name("d_zelenyi").tracker(64, 3, true).egg(-1, -1).build());
	}
