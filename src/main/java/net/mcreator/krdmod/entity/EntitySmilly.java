...
public class EntitySmilly extends ElementsKrdModMod.ModElement {
	public static final int ENTITYID = 47;
	public static final int ENTITYID_RANGED = 48;
	public EntitySmilly(ElementsKrdModMod instance) {
		super(instance, 71);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("krd_mod", "smilly"), ENTITYID)
				.name("smilly").tracker(64, 3, true).egg(-1, -1).build());
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modelsimlly(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("krd_mod:textures/demonsmili.png");
				}
			};
		});
	}
	...
	public static class Modelsimlly extends ModelBase {
		...
		public Modelsimlly() {
			...
			armright.cubeList.add(new ModelBox(armright, 40, 37, -5.0612F, 3.7144F, -1.7273F, 4, 7, 4, 0.0F, false));
			...
			upper_right_r1.cubeList.add(new ModelBox(upper_right_r1, 40, 32, -5.0591F, -1.4256F, -2.2467F, 4, 6, 4, 0.0F, false));
			armleft = new ModelRenderer(this);
			armleft.setRotationPoint(5.2437F, -21.182F, 1.6929F);
			body.addChild(armleft);
			armleft.cubeList.add(new ModelBox(armleft, 40, 32, 0.5645F, -1.4903F, -2.8129F, 4, 6, 4, 0.0F, true));
			...
			lower_left_r1.cubeList.add(new ModelBox(lower_left_r1, 40, 37, -2.03F, -0.2352F, -1.7914F, 4, 7, 4, 0.0F, true));
			leftFood = new ModelRenderer(this);
			leftFood.setRotationPoint(4.132F, 12.3136F, 0.7177F);
			leftFood.cubeList.add(new ModelBox(leftFood, 0, 38, -1.9874F, 6.6165F, -1.5819F, 4, 5, 4, 0.0F, true));
			leftFood.cubeList.add(new ModelBox(leftFood, 0, 33, -2.0019F, 0.732F, -1.6588F, 4, 6, 4, 0.0F, true));
			right_foot = new ModelRenderer(this);
			right_foot.setRotationPoint(-0.8035F, 12.4211F, 0.9759F);
			right_foot.cubeList.add(new ModelBox(right_foot, 0, 33, -1.2805F, 0.7576F, -1.9352F, 4, 6, 4, 0.0F, false));
			right_foot.cubeList.add(new ModelBox(right_foot, 0, 38, -1.3154F, 6.3591F, -1.8759F, 4, 5, 4, 0.0F, false));
		}
