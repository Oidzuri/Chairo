...
public class EntityDSusamaru extends ElementsKrdModMod.ModElement {

	public static final int ENTITYID = 29;
	public static final int ENTITYID_RANGED = 30;

	public EntityDSusamaru(ElementsKrdModMod instance) {
		super(instance, 37);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("krd_mod", "d_susamaru"), ENTITYID)
				.name("d_susamaru").tracker(64, 3, true).egg(-1, -1).build());
	}
