...
public class EntitySam extends ElementsKrdModMod.ModElement {

	public static final int ENTITYID = 41;
	public static final int ENTITYID_RANGED = 42;

	public EntitySam(ElementsKrdModMod instance) {
		super(instance, 39);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("krd_mod", "sam"), ENTITYID)
				.name("sam").tracker(64, 3, true).egg(-1, -1).build());
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modeljk(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("krd_mod:textures/demoncnew1.png");
				}
			};
		});
