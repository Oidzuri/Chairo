...
public class EntityYazik extends ElementsKrdModMod.ModElement {
	public static final int ENTITYID = 49;
	public static final int ENTITYID_RANGED = 50;
	public EntityYazik(ElementsKrdModMod instance) {
		super(instance, 72);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("krd_mod", "yazik"), ENTITYID)
				.name("yazik").tracker(64, 3, true).egg(-1, -1).build());
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modeldemon_yazik(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("krd_mod:textures/demonyazikdaun.png");
				}
			};
		});
	}
	...
	public static class Modeldemon_yazik extends ModelBase {
		...
		public Modeldemon_yazik() {
			...
			upper_right_r1.cubeList.add(new ModelBox(upper_right_r1, 40, 32, -5.0591F, -0.4256F, -2.2467F, 4, 5, 4, 0.0F, false));
